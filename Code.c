...
char msg5[15]  = "Enter New Code",msg6[15]="ROBBERY ALERT";
int i=0,j,cnt,fla=9,rt=3;
...
void main()
{
 ...
 Lcd_Out(2, 3, "Press *");
  ...
  if(code1[0] == 42)
  {
   ...
   code_enter();
   code_enter();
   if(code1[0] == '0' && code1[1] == '0' && code1[2] == '0' && code1[3] == '0' && code1[4] == '7')  //check master code
   {  fla=0;
   cnt=0;
    code_enter();
    if(code1[5] == 35)
